...
function EditListDetailElementComponent(props) {
    let walletID = '';
    ...
    const [inputCategoryName, setInputCategoryName] = useState(props.currentUnit.name)
    const [inputCategoryId, setInputCategoryId] = useState(props.currentUnit.id)
                         ...
                         units.map(
                            ...
                            <label className = "form-label text-size" htmlFor={unit.id}>
                              <input type="radio" id={unit.id} name="unit" value={unit.name} 
                                   defaultChecked = {unit.name === props.currentUnit.name}
...
export default EditListDetailElementComponent
